...
namespace Gsasl {
	...
	[Compact]
	[CCode (cname = "Gsasl", lower_case_cprefix = "gsasl_", free_function = "gsasl_done", has_copy_function = false)]
	...
	[Compact]
	[CCode (cname = "Gsasl_session", lower_case_cprefix = "gsasl_", free_function = "gsasl_finish", has_copy_function = false)]
