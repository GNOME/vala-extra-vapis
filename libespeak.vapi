...
namespace Espeak {
    ...
    public Error synth(void* text, size_t size, int position, PositionType position_type, uint end_position, uint flags, out uint unique_identifier, out void* user_data);
